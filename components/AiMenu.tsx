...
const AiMenu: React.FC<Props> = ({ onNavigate, onBack }) => {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12 md:py-20 relative z-10">
      ...
      >
        <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-purple-500/30 group-hover:bg-purple-500/10 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
        ...
        >
          ...
          <div className="relative h-full bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 overflow-hidden hover:bg-[#0a0a0a]/90 transition-colors flex flex-col">
            ...
            <h3 className="text-xl font-bold text-white mb-2 group-hover:text-pink-100 font-display uppercase">Prezentace</h3>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
