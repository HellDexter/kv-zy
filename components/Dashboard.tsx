    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-20 relative z-10 flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full max-w-4xl pb-10">
        ...
        <button
          ...
          className="group relative min-h-[280px] md:h-80 animate-fade-in-up text-left"
        ...
        >
          ...
          <div className="relative h-full bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-10 overflow-hidden hover:bg-[#0a0a0a]/90 transition-all duration-500 group-hover:border-cyan-500/30 flex flex-col justify-between">
            ...
            <div className="relative z-10">
              <div className="bg-cyan-950/30 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center border border-cyan-500/20 mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-500">
                <Shield className="w-6 h-6 md:w-8 md:h-8 text-cyan-400" />
              </div>
              <h2 className="text-2xl md:text-3xl font-display text-white mb-2 md:mb-3 uppercase">Kyberbezpečnost</h2>
              <p className="text-sm md:text-base text-gray-400 font-light leading-relaxed">
                Komplexní průvodce digitální obranou. Kvízy, ochrana dat a prevence útoků.
              </p>
            </div>
            
            <div className="relative z-10 flex items-center gap-2 text-cyan-400 text-xs md:text-sm font-bold tracking-widest uppercase mt-4 font-mono">
        ...
        <button
          ...
          className={`group relative min-h-[280px] md:h-80 animate-fade-in-up text-left cursor-not-allowed ${shakeAi ? 'animate-shake' : ''}`}
        ...
        >
          ...
          <div className="relative h-full bg-[#0a0a0a]/60 backdrop-blur-sm border border-white/5 rounded-3xl p-6 md:p-10 overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-300 group-hover:border-red-500/20 flex flex-col justify-between">
            {/* Locked Overlay */}
            ...
            <div className="relative z-10 opacity-50 group-hover:opacity-70 transition-opacity">
              <div className="bg-white/5 w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center border border-white/10 mb-4 md:mb-6">
            ...
            <div className="relative z-10 flex items-center gap-2 text-gray-500 text-xs md:text-sm font-bold tracking-widest uppercase mt-4 font-mono">
              Nedostupné
            </div>
          </div>
        </button>
