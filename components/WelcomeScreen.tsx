        ...
        {blocks.map((block, index) => {
           ...
           return (
            ...
            >
              ...
              <div className="relative h-full bg-[#0a0a0a]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-8 overflow-hidden hover:bg-[#0a0a0a]/80 transition-all duration-300 group-hover:border-emerald-500/30 hover:-translate-y-1">
                ...
                <div className="flex justify-between items-start mb-6">
                    <div className="w-12 h-12 rounded-xl bg-emerald-950/20 border border-emerald-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
